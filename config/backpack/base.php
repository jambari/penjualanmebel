...
return [
    ...
    */
    ...
    'project_name' => 'CV Mebel Karya Utama',
    ...
    'project_logo'   => '<img src="/images/a.png" alt="logo mebel karya utama" width="50" height="50"> <i>CV MKU</i>',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-indigo border-0 navbar navbar-color',
